...
export declare const unwrapComponentTree: (component: Component | MaybeRef<LNode> | Signal<LNode> | MaybeSignal<LNode>, propagatedAttribs?: LNodeAttributes) => MaybeRef<LNode> | MaybeSignal<LNode>;
