...
export type UnwrappableComponent = Component | MaybeRef<LNode> | Signal<LNode> | MaybeSignal<LNode> | string;
export type UnwrappedComponent = MaybeRef<LNode> | MaybeSignal<LNode>;
export type Component<T extends Dict = Dict> = (props?: T & LNodeAttributes) => MaybeRef<LNode> | Component | Signal<LNode> | MaybeSignal<LNode> | string;
